...
GRANT SELECT, INSERT, UPDATE, DELETE ON SINHVIEN TO role_nv_ctsv;
GRANT UPDATE ON SINHVIEN TO role_nv_pdt;
...
-- Gán roles cho users
GRANT role_sinhvien TO user_sv001;
GRANT role_gv TO user_gv001;
GRANT role_nv_ctsv TO user_ctsv001;
GRANT role_nv_pdt TO user_pdt001;
