...
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.NHANVIEN TO GV;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.DANGKY TO GV;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.SINHVIEN TO GV;

GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.NHANVIEN TO NVPKT;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.DANGKY TO NVPKT;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.SINHVIEN TO NVPKT;

GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.NHANVIEN TO NVTCHC;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.DANGKY TO NVTCHC;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHOOL_USER.SINHVIEN TO NVTCHC;
